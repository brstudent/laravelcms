                ...
                @foreach ($pages as $page)
                    <tr>
                        ...
                        <td>
                            ...
                            <form method="POST" class="d-inline" action="{{route('pages.destroy', ['page'=>$page->id])}}" onsubmit="return confirm('Tem certeza que deseja excluir esse usuário?')">
                                @method('DELETE')
                                @csrf
